...
function submitLogin(){
		...
		$('.newportLoggedIn').on('click','.newport-content-btn',function(event){
			...
			//Newport content
			$('#newport-content').append('<div id="newport-content"class="clearDiv main-content-divPadding"><div class="newport-content-img col-sm-6 col-xs-12"><h2>Newport Wheel of Pleasure Game</h2><img src="imgs/newportContentImg.png"/></div><!--content-img--><div class="content-description col-sm-6 col-xs-12"><h2>Project:</h2><p>Lorillard Newport Wheel of Pleasure Mobile Game - (HTML5, CSS3, jQuery)</p><h2>Description:</h2><p>This project was for one of our AFG clients <a href="http://www.lorillard.com/brands/newport/" target="_blank">Lorillard</a>. Every year we are asked to develop a desktop and mobile version of the same game. We developed a mobile version of the game "Wheel of Pleasure", in which the user presses the play button and the result lands on either a winner or loser, comparable to ABCs Wheel of Fortune. Because of the disclosure legality of this website, I cannot openly show the website. In order to view the site please contact me and I will provide you with a temporary username and password to view my work on this project. However, you can view a code snippet from this game below. <a href="#codeExamples">Click Here to view snippet</a></p><a class="overlay_btn restricted-site newport-site">View Site</a><!--view site btn--></div><!--content-description--></div><!--newport content-->');
